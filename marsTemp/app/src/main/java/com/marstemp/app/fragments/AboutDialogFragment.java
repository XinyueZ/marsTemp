package com.marstemp.app.fragments;
...
import com.marstemp.app.activities.WebViewActivity;
...
public final class AboutDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		aboutBody.append(Html.fromHtml(getString(R.string.about_body, getString(R.string.application_name),
				versionName)));
